...
func TestBasicFail(t *testing.T) {
	...
	fmt.Printf("Test 1: Single primary, no backup ...\n")
	...
	fmt.Printf("Test 2: Add a backup ...\n")
	...
	fmt.Printf("Test 3: Count RPCs to viewserver ...\n")
	...
	fmt.Printf("Test 4: Primary failure ...\n")
	...
	fmt.Printf("Test 5: Kill last server, new one should not be active ...\n")
...
func TestAtMostOnce(t *testing.T) {
	...
	fmt.Printf("Test 6: at-most-once Append; unreliable ...\n")
...
func TestFailPut(t *testing.T) {
	...
	fmt.Printf("Test 7: Put() immediately after backup failure ...\n")
	s2.kill()
	ck.Put("a", "aaa")
	check(ck, "a", "aaa")
	...
	fmt.Printf("Test 8: Put() immediately after primary failure ...\n")
	s1.kill()
	ck.Put("b", "bbb")
	check(ck, "b", "bbb")
...
func TestConcurrentSame(t *testing.T) {
	...
	fmt.Printf("Test 9: Concurrent Put()s to the same key ...\n")
...
func TestConcurrentSameAppend(t *testing.T) {
	...
	fmt.Printf("Test 10: Concurrent Append()s to the same key ...\n")
...
func TestConcurrentSameUnreliable(t *testing.T) {
	...
	fmt.Printf("Test 11: Concurrent Put()s to the same key; unreliable ...\n")
...
func TestRepeatedCrash(t *testing.T) {
	...
	fmt.Printf("Test 12: Repeated failures/restarts ...\n")
...
func TestRepeatedCrashUnreliable(t *testing.T) {
	...
	fmt.Printf("Test 13: Repeated failures/restarts with concurrent updates to same key; unreliable ...\n")
...
func TestPartition1(t *testing.T) {
	...
	fmt.Printf("Test 14: Old primary does not serve Gets ...\n")
...
func TestPartition2(t *testing.T) {
	...
	fmt.Printf("Test 15: Partitioned old primary does not complete Gets ...\n")
