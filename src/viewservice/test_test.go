...
func Test1(t *testing.T) {
	...
	fmt.Printf("Test 7: Dead backup is removed from view ...\n")
	...
	fmt.Printf("Test 8: Viewserver waits for primary to ack view ...\n")
	...
	// cannot take over.
	fmt.Printf("Test 9: Uninitialized server can't become primary ...\n")
